import { on_event } from './snippets/ported-359020cdefcb543b/events.js';
import { ws_local_storage_keys } from './snippets/ported-359020cdefcb543b/local_storage.js';
...
*/
export function add_address(project_id, name, address) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(address, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.add_address(project_id, ptr0, len0, ptr1, len1);
...
* @returns {Promise<void>}
*/
export function remove_address(project_id, name) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.remove_address(project_id, ptr0, len0);
    return takeObject(ret);
}
...
* @returns {Promise<any>}
*/
export function get_address_map(project_id) {
    const ret = wasm.get_address_map(project_id);
    return takeObject(ret);
}
...
export class AddressMap {
    ...
    */
    static set(project_id, list) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.addressmap_set(retptr, project_id, addHeapObject(list));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    static add(name) {
        try {
            ...
            const ptr0 = passStringToWasm0(name, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            wasm.listprojects_add(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
